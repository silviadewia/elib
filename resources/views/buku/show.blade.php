...
<section class="content-header">
    <h1>
        <i class="fa fa-book" style="color:green"> </i> Data Buku Detail </h1>
    <ol class="breadcrumb">
        <li><a href=""><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
        <li class="active"><i class="fa fa-book"></i>&nbsp; Data Buku Detail</li>
    </ol>
</section>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    ...
                                                    style="width: 0px;">ID</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1" aria-label="Nama: activate to sort column ascending"
                                                    style="width: 0px;">Nama</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Tgl Pinjam: activate to sort column ascending"
                                                    style="width: 0px;">Tgl Pinjam</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Lama Pinjam: activate to sort column ascending"
                                                    style="width: 0px;">Lama Pinjam</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1" aria-label="Jml: activate to sort column ascending"
                                                    style="width: 0px;">Jml</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="odd">
                                    ...
                                    <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
                                        <ul class="pagination">
                                            ...
                                            <li class="paginate_button next disabled" id="example1_next"><a href="#"
                                                    aria-controls="example1" data-dt-idx="1" tabindex="0">Next</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
